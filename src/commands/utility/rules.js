...
function buildRulesEmbeds() {
  ...
  return [
    ...
    new EmbedBuilder()
      .setColor(BLUE)
      .setTitle("👤 1.1 Уважение")
      .addFields(
        { name: "📌 Правило", value: "Уважайте всех участников сервера. Оскорбления, угрозы и грубые высказывания запрещены." },
        { name: "⚖️ Наказания", value: "1-е: ⚠️ предупреждение\n2-е: 🔇 мут на **3 часа**\nПовторное: 🚫 бан на **1 день**" }
      ),

    // 1.2 Язык
    new EmbedBuilder()
      .setColor(BLUE)
      .setTitle("🌐 1.2 Язык общения")
      .addFields(
        { name: "📌 Правило", value: "Основной язык сервера — **русский**. Использование других языков допускается только в соответствующих каналах." },
    ...
    new EmbedBuilder()
      .setColor(BLUE)
      .setTitle("💬 2.1 Флуд и спам")
      .addFields(
        { name: "📌 Правило", value: "Запрещено флудить и спамить в любых каналах. Поддерживайте тематические обсуждения." },
