...
* [Discord.js](https://www.npmjs.com/package/discord.js/v/13.15.1) v14
...
* **Social**: `reputation list,` `reputation give,` ...
* **Ticket**: `setup`, `close`, `log`, ...
* **Utility**: `proxies`, `translation`, `weather`, ...
